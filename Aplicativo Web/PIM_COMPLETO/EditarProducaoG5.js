...
class BackButtonHandler extends ButtonHandler {
    constructor() {
        super('.back-button', () => {
            window.location.href = 'ProducaoG.html'; // Redireciona para a tela de Produção
        });
    }
}
...
class HomeButtonHandler extends ButtonHandler {
    constructor() {
        super('#homeButton', () => {
            window.location.href = 'inicialGerente.html'; // Caminho da página inicial
        });
    }
}
...
class SaveButtonHandler extends ButtonHandler {
    constructor() {
        super('#save-button', (event) => {
            ...
            window.location.href = confirmation ? 'ProducaoG.html' : 'EditarProducaoG5.html';
        });
    }
}
