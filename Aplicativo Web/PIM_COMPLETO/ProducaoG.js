...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new NavigationButton('#backButton', 'inicialGerente.html');  // Cria uma instância de NavigationButton para o botão de voltar
    ...
    if (newProductionButton) {
        newProductionButton.addEventListener('click', () => {
            window.location.href = 'NovaProducaoG.html';  // Redireciona para a página de nova produção quando o botão é clicado
        });
    }
});
