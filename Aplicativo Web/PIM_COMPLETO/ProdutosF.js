...
function openModal(produto) {
    ...
    modalDetails.innerHTML = `Nome: ${produto.nome}<br>ID: ${produto.id-produto}<br> Quantidade: ${produto.quantidade}<br> Valor: ${produto.valor}<br> `; // Atualiza os detalhes do modal
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (newProductButton) {
        newProductButton.addEventListener('click', () => {
            window.location.href = 'NovoProdutoF.html';
        });
    }
