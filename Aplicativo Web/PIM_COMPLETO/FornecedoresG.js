...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new Navigation('.buttons button:nth-child(2)', 'NovoFornecedorG.html');
    new BackButton('.back-button', 'inicial.html');
    carregarFornecedores();
    new InativarFornecedor('.inactivate-button', '.supplier-list');
    new BackButton('.buttons button:nth-child(1)', 'inicialGerente.html');
    new Navigation('.inactivated-suppliers-button', 'ListaFornecedorInativoG.html');
});
